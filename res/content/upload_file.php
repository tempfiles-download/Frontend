<div class="upload_file">
  <center>
    ...
    <form class="form-horizontal center upload-form" action="#" enctype="multipart/form-data" method="POST" accept-charset="UTF-8">
      ...
      <center><div class='form-group'><button class="btn btn-lg btn-success" type="submit" name="upload-submit" id="upload-submit" style="padding: 10px">Upload File</button></div></center>
    </form>
  <?php } ?>
</div>