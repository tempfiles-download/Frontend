            ...
            <div class="center">
                ...
                <?php if (isset($id) && $id[0]) {
                    ...
                    <div id="upload_success">
                        ...
                        <div class="form-group has-success">
                            <label class="control-label col-sm-2" for="id">Deletion Password</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="<?php echo $deletionpass; ?>" readonly="" style="width: auto" onClick="this.select();">
                            </div>
                        </div>
                    </div>
                    <?php
