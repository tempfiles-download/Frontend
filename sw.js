...
async function handleFileUpload(request) {
  ...
  // Encrypt file data
  const encryptedFile = await encryptData(file, formData.get('password'));
  console.log(encryptedFile)
  // Create a new FormData object with the encrypted file data
  const encryptedFormData = new FormData();
  encryptedFormData.append('encryptedFile', encryptedFile);
  console.log(encryptedFormData)
  // Forward the request to the server with encrypted file data
